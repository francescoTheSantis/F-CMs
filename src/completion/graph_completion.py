...
def complete_graph(adj_matrix_pd,
    ...
    if problematic_conceptPairs:
        for [c1,c2] in problematic_conceptPairs: # change to some clever procedure
            ...
            prompt = prompt_template_cot.format(context=retrieved_context, concept_1=c1, concept_2=c2, concept_1_description=c1_description, concept_2_description=c2_description)
