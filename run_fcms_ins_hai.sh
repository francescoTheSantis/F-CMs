#!/bin/bash
#SBATCH --job-name=fcms_ins_hai  # Job name
...
# Run training
# python main.py --config-name=test_insurance &
# sleep 10
# python main.py --config-name=test_insurance_s &

# wait  # Wait for all background processes to finish

# python main.py --config-name=test_hailfinder &
# sleep 10
# python main.py --config-name=test_hailfinder_s &
