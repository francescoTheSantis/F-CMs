...
echo "=== Start CheXpert Multi (all_v2) ==="
python main.py --config-name=test_chexpert_multi_v2 &
sleep 30
echo "=== Start CheXpert Multi (all_v3) ==="
python main.py --config-name=test_chexpert_multi_v3 &

wait  # Wait for all background processes to finish

echo "=== Start CheXpert Multi (static_v2) ==="
python main.py --config-name=test_chexpert_multi_s_v2 &
sleep 30
echo "=== Start CheXpert Multi (static_v3) ==="
python main.py --config-name=test_chexpert_multi_s_v3 & 
